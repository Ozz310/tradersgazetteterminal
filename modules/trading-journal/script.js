document.addEventListener('DOMContentLoaded', () => {
  ...
  async function initializeUserSession() {
    try {
      ...
      loadTrades(); // ADDED: Call loadTrades after sheet creation
    } catch (error) {
  ...
  if (addEntryButton && tradeForm && entryFormCard) { // ADDED: check for entryFormCard
  ...
  if (uploadCsvButton && uploadCsvForm && uploadCsvModal) { // ADDED: check for uploadCsvModal
  ...
  if (tableTab && analyticsTab && tableView && analyticsView) {
    tableTab.addEventListener('click', () => {
      ...
      loadTrades(); // ADDED: Reload data when switching to table view
    });
