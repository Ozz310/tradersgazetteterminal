// /assets/js/app.js - FULL UPDATED FILE
...
    };
    ...
    // ⭐ ADDED FUNCTION: Load the main stylesheet once
    const loadMainCSS = () => {
        const mainCssId = 'main-app-style';
        if (!document.getElementById(mainCssId)) {
            const link = document.createElement('link');
            link.rel = 'stylesheet';
            // Use the full path for GitHub Pages stability
            link.href = '/tradersgazetteterminal/assets/css/style.css'; 
            link.id = mainCssId;
